...
export default function SecureMessaging() {
    return (
        <div className="h-[calc(100vh-160px)] flex glass-effect rounded-sm overflow-hidden border border-border transition-colors duration-300">
            {/* Contact List */}
            <div className="w-80 border-r border-border flex flex-col bg-foreground/[0.01]">
                <div className="p-4 border-b border-border space-y-4">
                    <h3 className="text-xs font-mono text-foreground/40 uppercase tracking-widest">Secure Contacts</h3>
                ...
                <div className="flex-1 overflow-y-auto">
                    {contacts.map((contact) => (
                        <div key={contact.id} className="p-4 border-b border-border/50 hover:bg-foreground/[0.02] cursor-pointer transition-all group">
            ...
            <div className="flex-1 flex flex-col bg-background">
                {/* Chat Header */}
                <div className="p-4 border-b border-border flex items-center justify-between bg-foreground/[0.01]">
                    <div className="flex items-center space-x-4">
                        <div className="w-10 h-10 rounded-full bg-emerald-icpc/10 border border-emerald-icpc/30 flex items-center justify-center">
                            <User className="w-6 h-6 text-emerald-icpc" />
                        </div>
                        <div>
                            <h4 className="text-sm font-bold text-foreground">Director Alabi</h4>
                            <div className="flex items-center space-x-2">
                                <div className="w-1.5 h-1.5 rounded-full bg-emerald-icpc"></div>
                                <span className="text-[10px] font-mono text-emerald-icpc uppercase font-bold">Encrypted E2EE Link</span>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center space-x-3">
                ...
                {/* Messages */}
                <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-foreground/[0.01]">
                    ...
                    <div className="flex justify-start max-w-[80%]">
                        <div className="bg-foreground/[0.03] border border-border p-4 rounded-sm space-y-2">
                    ...
                    <div className="flex justify-end ml-auto max-w-[80%]">
                        <div className="bg-emerald-icpc/10 border border-emerald-icpc/30 p-4 rounded-sm space-y-2">
                    ...
                    <div className="flex justify-start max-w-[80%]">
                        <div className="bg-foreground/[0.03] border border-border p-4 rounded-sm space-y-2">
                            ...
                            <div className="p-3 bg-black/20 rounded-sm border border-white/5 flex items-center justify-between group cursor-pointer hover:bg-black/30 transition-all">
                                <div className="flex items-center space-x-3">
                                    <div className="w-8 h-8 bg-restricted-red/20 flex items-center justify-center rounded-sm">
                                        <Lock className="w-4 h-4 text-restricted-red" />
                                    </div>
                                    <span className="text-[10px] font-mono text-foreground/60 uppercase tracking-tighter">SEC_K_AUDIT_DRAFT.pdf</span>
                                </div>
                                <span className="text-[9px] text-foreground/30 group-hover:text-foreground">Decrypt</span>
                            </div>
                ...
                <div className="p-4 border-t border-border bg-foreground/[0.01]">
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-3 text-foreground/20">
                            <span className="text-[9px] font-mono uppercase tracking-widest">Secure Input Mode</span>
                        </div>
                    </div>
                </div>
            </div>
